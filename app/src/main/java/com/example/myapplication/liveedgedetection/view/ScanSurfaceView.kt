package com.example.myapplication.liveedgedetection.view
...
import com.example.myapplication.liveedgedetection.utils.configureCameraAngle
import com.example.myapplication.liveedgedetection.utils.decodeBitmapFromByteArray
...
class ScanSurfaceView(context: Context, iScanner: IScanner, val TIME_HOLD_STILL: Long = DEFAULT_TIME_POST_PICTURE) : FrameLayout(context), SurfaceHolder.Callback {
    ...
    companion object {
        private const val TIME_POST_PICTURE = 100L
        const val DEFAULT_TIME_POST_PICTURE = 110L
    }
}